...
export type ComicsQuery = { __typename?: 'Query', comics: Array<{ __typename?: 'Comic', id: string, image: string, name: string, publisher?: string | null, description: string, person_credits?: Array<string | null> | null }> };
